    ...
    try {
      if (text === "/start") {
        ...
        return bot.sendMessage(
          chatId,
          `Добро пожаловать в телеграм бот ZabanovDBot!`
        );
      }
      ...
      if (text === "/info") {
        ...
        return bot.sendMessage(
          chatId,
          `Тебя зовут ${msg.from.first_name} ${msg.from.last_name}, в игре у тебя правильных ответов ${user.right}, неправильных ответов ${user.wrong}`
        );
      }
